...
The Movie ID is the key in obtaining information about the movie being rated. 
...
The Rater.java class supports queries about ratings made by one rater, like what movies have been rated, and what the rating for a specific movie is.
...
* Two private variables to represent information about a rating:
    * item - a String description of the item being rated 
